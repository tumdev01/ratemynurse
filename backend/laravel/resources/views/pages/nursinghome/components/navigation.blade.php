<div class="p-4 mb-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 flex flex-row gap-4">
    <a href="{{ route('nursing-home.edit-staff', $nursinghome->id) }}" class="flex items-center gap-2">
    ...
    <a href="{{ route('nursing-home.edit-rate', $nursinghome->id) }}" class="flex items-center gap-2">
    ...
    <a href="{{ route('nursing-home.room.index', $nursinghome->id) }}" class="flex items-center gap-2">
        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
